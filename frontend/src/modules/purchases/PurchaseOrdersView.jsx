    ...
    <div className="bg-white min-h-screen flex flex-col">
       ...
       <div className="flex items-center justify-between px-8 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
             <h1 className="text-[24px] font-bold text-slate-900 tracking-tight">Purchase Orders</h1>
             ...
             {filteredOrders.length > 0 ? (
                <div className="p-8 animate-in fade-in duration-500">
                   <table className="w-full text-left">
                      <thead className="bg-slate-50/50 text-[11px] font-bold text-slate-500 uppercase tracking-widest border-b border-slate-100">
                         <tr>
                      ...
                      <div className="grid grid-cols-3 gap-0 w-full max-w-[600px] mb-12 relative p-10 bg-slate-50/50 rounded-[40px] border border-slate-100">
                         ...
                         <div className="flex flex-col items-center gap-4 relative z-10 group">
                            ...
                            <div className="text-center">
                               <div className="text-[11px] font-bold text-slate-900 uppercase tracking-widest mb-1">Create Draft</div>
                         ...
                         <div className="flex flex-col items-center gap-4 relative z-10 group">
                            ...
                            <div className="text-center">
                               <div className="text-[11px] font-bold text-slate-900 uppercase tracking-widest mb-1">Send to Vendor</div>
                         ...
                         <div className="flex flex-col items-center gap-4 relative z-10 group">
                            ...
                            <div className="text-center">
                               <div className="text-[11px] font-bold text-slate-900 uppercase tracking-widest mb-1">Receive Goods</div>

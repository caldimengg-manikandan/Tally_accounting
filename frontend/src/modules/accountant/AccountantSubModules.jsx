    ...
    <div className="flex-1 flex flex-col items-center justify-center p-20 animate-fade-in text-center space-y-8 min-h-[60vh]">
      ...
      <div className="space-y-3 max-w-lg">
        <div className="flex items-center justify-center gap-3">
           ...
           <h3 className="text-[11px] font-black text-amber-500 uppercase tracking-[0.3em]">Module in Development</h3>
        </div>
        <h1 className="text-4xl font-black text-slate-800 tracking-tighter">{title}</h1>
      ...
      <div className="flex gap-4 pt-4">
         <button className="px-8 py-3 bg-slate-900 text-white rounded-xl font-black text-[11px] uppercase tracking-widest hover:-translate-y-0.5 transition-all shadow-xl shadow-slate-200">
           Notify Me on Launch
         </button>
         <button disabled className="px-8 py-3 bg-white border border-slate-100 text-slate-300 rounded-xl font-black text-[11px] uppercase tracking-widest">
           View documentation
         </button>
      </div>
